        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-400 lg:max-w-lg">
              <p>
               <span className="font-semibold text-slate-100">Maintain Continuous Protection of Your Design</span>
                <br/>
                We ensure your registered design remains protected by managing timely renewals and compliance requirements.
              </p>
              ...
              <p className="mt-3 font-semibold text-slate-100">Key Information</p>
              <ul role="list" className="mt-5 space-y-5 text-gray-400">
                <li className="flex gap-x-1">
                  ...
                  <span>
                  Validity: <span className="font-semibold text-slate-100">10 years from registration</span>
                  </span>
                </li>
                <li className="flex gap-x-1">
                  <ChevronDoubleRightIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />
                  <span>
                  Extension: <span className="font-semibold text-slate-100">Additional 5 years upon renewal</span>
                  </span>
                </li>
                <li className="flex gap-x-1">
                  <ChevronDoubleRightIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />
                  <span>
                  Risk: <span className="font-semibold text-slate-100">Non-renewal may lead to loss of rights</span>
                  </span>
                </li>
              </ul>
              <br/><hr/><br/>

              <p className="mt-2 font-semibold text-slate-100">What We Do</p>
              <ul role="list" className="mt-5 space-y-5 text-gray-400">
                <li className="flex gap-x-1">
                  <ChevronDoubleRightIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />
                  <span>
                ...
                <li className="flex gap-x-1">
                  <ChevronDoubleRightIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />
                  <span>
                  Handle delayed renewals (if applicable)  
                  </span>
                </li>
                <li className="flex gap-x-1">
                  <ChevronDoubleRightIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />

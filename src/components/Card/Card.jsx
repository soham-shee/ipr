...
const Card = ({
  ...
  return (
    <div className="relative w-64 bg-white shadow-lg p-8 space-y-3 overflow-hidden rounded-2xl transition hover:-translate-y-1 hover:shadow-xl" onClick={handleClick}>

      {/* Circle number */}
      <div className="absolute -right-6 -top-8 w-24 h-24 bg-slate-500 rounded-full flex items-end justify-start pl-7 pb-5">
        <span className="text-white text-2xl font-semibold">{number}</span>
      </div>

      {/* Icon */}
      <div className="w-12 fill-slate-500">
